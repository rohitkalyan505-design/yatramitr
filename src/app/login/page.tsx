        ...
        code.includes('invalid-credential') || code.includes('wrong-password')
          ...
          : code.includes('user-not-found')
            ...
            : code.includes('too-many-requests')
              ...
              : 'Sign-in failed. You can also explore Yatra Mitra with a demo session.'
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-12 rounded-3xl overflow-hidden shadow-2xl border border-forest-900/10 bg-sand-50">
        ...
        <div className="md:col-span-5 relative bg-forest-950 p-8 sm:p-10 text-[#F5F1E8] flex flex-col justify-between overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Charmilar-_Hyderabad.jpg/1280px-Charmilar-_Hyderabad.jpg"
        ...
        <div className="md:col-span-7 p-8 sm:p-12 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <a href="#" onClick={(e) => e.preventDefault()} className="text-[11px] text-terracotta-600 hover:underline" title="Password reset uses Firebase Auth email">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
          ...
          <button
            onClick={handleDemo}
            className="w-full px-6 py-3.5 rounded-xl border-2 border-dashed border-[#B8955A] text-forest-900 font-bold text-sm hover:bg-gold-100/50 transition-colors"
          >
